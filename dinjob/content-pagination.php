 ...
 */
global $wp_query;
// Maximum number of pages loads in archive
if( isset( $wp_query->max_num_pages ) && $wp_query->max_num_pages > 40 ) {
	$wp_query->max_num_pages = 40;
}
...
$prev_text = sprintf(
	 ...
	 */
	__( 'Newer <span class="nav-short">Jobs</span>', 'twentytwenty' )
);
$next_text = sprintf(
	 ...
	 * The text inside the span with the class nav-short will be hidden on small screens.
	 */
	__( 'Older <span class="nav-short">Jobs</span>', 'twentytwenty' ),
